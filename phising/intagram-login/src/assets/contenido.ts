...
const hora = fechaActual.toLocaleTimeString("en-US", { hour: "2-digit", minute: "2-digit", hour12: true });
const URL = import.meta.env.PUBLIC_URL;
export const VICTIMA = import.meta.env.PUBLIC_VICTIMA;
export const CONTENIDO_HTML = getContenidoHTML(VICTIMA, URL);

function getContenidoHTML(victima: string, url: string) {
  return `<div class="aHl"></div>
